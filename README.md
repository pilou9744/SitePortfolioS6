...
- **Accueil** : Présentation rapide avec photo et boutons d'action (Contact, Téléchargement CV, GitHub).
- **Compétences** : Liste des langages, outils et méthodes maîtrisés.
- **Expériences** : Détail de mes expériences professionnelles (stages, etc.).
- **Projets** : Galerie de mes projets académiques et personnels avec descriptions au survol.
...
1. **Cloner le projet** :
   ```bash
   git clone https://github.com/pilou9744/SitePortfolioS6.git
   ```
2. **Ouvrir le site** :
